...
static	int		fs_packFiles = 0;		// total number of files in
...
int FS_GetModList( char *listbuf, int bufsize )
{
	...
	const char * const paths[] = { fs_basepath->string, fs_homepath->string }; // , fs_steampath->string, fs_gogpath->string }; // Cowcat
