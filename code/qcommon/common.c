...
void Z_Free( void *ptr )
{
	...
	block->id = ZONEID;	// Quake3e ( missing/needed ? - Cowcat )
...
========================
*/
static void Z_LogZoneHeap( memzone_t *zone, char *name )
{
#ifdef ZONE_DEBUG
	char 		dump[32], *ptr;
	int  		i, j;
...
static sysEvent_t	*lastEvent = eventQueue + MAX_QUEUED_EVENTS - 1;
...
void Com_QueueEvent( int evTime, sysEventType_t evType, int value, int value2, int ptrLength, void *ptr )
{
	sysEvent_t  *ev;
...
//	Swap_Init ();
  ...
  // get dedicated here for proper hunk megs initialization
	...
	//
	com_altivec = Cvar_Get ("com_altivec", "0", CVAR_ARCHIVE); // was 1 - Cowcat
