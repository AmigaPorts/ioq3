...
void R_Register( void ) 
{
	...
	r_fullscreen = ri.Cvar_Get( "r_fullscreen", "0", CVAR_ARCHIVE ); // was 1 - Cowcat
	...
	r_textureMode = ri.Cvar_Get( "r_textureMode", "GL_NEAREST", CVAR_ARCHIVE ); // was GL_LINEAR_MIPMAP_NEAREST - Cowcat
	...
	r_shadows = ri.Cvar_Get( "cg_shadows", "0", 0 ); // was 1 - Cowcat
